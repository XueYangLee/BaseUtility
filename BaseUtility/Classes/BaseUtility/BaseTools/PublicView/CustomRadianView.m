...
#import "CustomRadianView.h"
#import "UtilityMacro.h"

@implementation CustomRadianView
...
- (void)setRadian:(CGFloat) radian
{
    ...
    switch (self.direction) {
        case CustomRadianDirectionBottom:
        case CustomRadianDirectionTop:
            _maxRadian =  MIN(t_height, t_width / 2);
            break;
        case CustomRadianDirectionLeft:
        case CustomRadianDirectionRight:
